...
WebUI.navigateToUrl('http://www.zeenyx.com/')

WebUI.mouseOver(findTestObject('Zeenyx/ZeenyxMainPage/Lnk_CONTACT'))

WebUI.waitForElementVisible(findTestObject('Zeenyx/ZeenyxMainPage/Lnk_Info Request'), 5)

WebUI.click(findTestObject('Zeenyx/ZeenyxMainPage/Lnk_Info Request'))
